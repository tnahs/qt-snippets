...
class SyntaxHighlighter(PySide6.QtGui.QSyntaxHighlighter):
    def __init__(self, parent: PySide6.QtGui.QTextDocument) -> None:
        super().__init__(parent)

        keyword_format = PySide6.QtGui.QTextCharFormat()
        keyword_color = PySide6.QtGui.QColor("red")
        ...
        singleton_format = PySide6.QtGui.QTextCharFormat()
        singleton_color = PySide6.QtGui.QColor("yellow")
        ...
        function_builtin_format = PySide6.QtGui.QTextCharFormat()
        function_builtin_color = PySide6.QtGui.QColor("green")
        ...
        misc_characters_format = PySide6.QtGui.QTextCharFormat()
        misc_characters_color = PySide6.QtGui.QColor("purple")
        ...
        string_format = PySide6.QtGui.QTextCharFormat()
        string_color = PySide6.QtGui.QColor("magenta")
        string_format.setForeground(string_color)
        string = re.compile(r"[\'\"].*?[\'\"]")
        string_expression: dict = {string: string_format}

        function_format = PySide6.QtGui.QTextCharFormat()
        function_color = PySide6.QtGui.QColor("green")
        function_format.setForeground(function_color)
        function = re.compile(r"(?<=def )\w*?(?=\(\):)")
        function_expression: dict = {function: function_format}

        comments_format = PySide6.QtGui.QTextCharFormat()
        comments_color = PySide6.QtGui.QColor("lightgray")
        ...
        whitespace_format = PySide6.QtGui.QTextCharFormat()
        whitespace_color = PySide6.QtGui.QColor("white")
        ...
        transparent_color = PySide6.QtGui.QColor(0, 0, 0, 0)
        transparent_format = PySide6.QtGui.QTextCharFormat()
...
class MainWindow(PySide6.QtWidgets.QFrame):
    ...
    def _init_ui(self) -> None:
        ...
        self._plain_text_edit = PySide6.QtWidgets.QPlainTextEdit(
            """
def my_function():
    # Do something!
    for item in ["hi!", None, False]:
        ...
        text_option.setFlags(
            text_option.flags() | PySide6.QtGui.QTextOption.ShowTabsAndSpaces
        )
